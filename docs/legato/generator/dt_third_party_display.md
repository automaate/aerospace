...
This tutorial requires knowledge of how to create an MPLAB Harmony project and using MPLAB Harmony Graphics Composer to design a screen. These processes will not be covered in this tutorial. 
