...
|---------------| ---------|---------------| ---------|
| legato_adv_e70_xu_tm5000_ssd1963.X | PIC32MZ EF Curiosity 2.0 | Legato Graphics w/ PDA TM4301B Display | PIC32MZ EF Curiosity 2.0 with SSD1963 GFX Interface and 4.3” WQVGA PCAP Touch display |
